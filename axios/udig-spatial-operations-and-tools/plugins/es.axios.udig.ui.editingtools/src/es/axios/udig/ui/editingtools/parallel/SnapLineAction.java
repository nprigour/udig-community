...
import es.axios.udig.ui.editingtools.internal.commons.behaviour.SnapToLineEditPointProvider;
 ...
 * @since 0.2.0
 */
public class SnapLineAction extends AbstractEditModifierActionDelegate {
    ...
    protected void activate() {
        ...
        setEditPointProvider(new SnapToLineEditPointProvider());
    }

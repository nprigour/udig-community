...
public class DrawGeomColorCommnad extends AbstractDrawCommand {
	...
	public DrawGeomColorCommnad(EditToolHandler handler, SegmentCopyContext parallelContext) {
	...
	public void run(IProgressMonitor monitor) throws Exception {
		...
		// FIXME select reference line segment.
		// When there is no reference line to draw, return.
		if (segmentCopyContext.getReferenceLine() == null) {
			return;
		}
		List<EditGeom> geoms = new LinkedList<EditGeom>();
		geoms.add(segmentCopyContext.getReferenceLine());

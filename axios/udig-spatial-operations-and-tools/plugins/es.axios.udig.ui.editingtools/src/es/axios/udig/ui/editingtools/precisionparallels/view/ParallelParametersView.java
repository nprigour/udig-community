 ...
 */
package es.axios.udig.ui.editingtools.precisionparallels.view;
...
/**
 * The view of the {@link PrecisionParallelTool}.
 * 
...
public class ParallelParametersView extends ViewPart implements IUDIGView, Observer {
	...
	public static final String			id					= "es.axios.udig.ui.editingtools.precisionparallels.view.ParallelParametersView";	//$NON-NLS-1$
